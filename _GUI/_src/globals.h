...
namespace globals {
    ...
    const unsigned int MEMORYWINDOW_PIXMAP_WIDTH = 100;
    const unsigned int MEMORYWINDOW_PIXMAP_HEIGHT = 100;
    ...
    const unsigned int PLOT_XRANGE = 5;
    const unsigned int PLOT_YRANGE = 10;
}
